...
class TestPolicyDecideOrder:
    ...
    def test_grave_objection_before_default(self):
    ...
    def test_new_doctor_before_default(self):
...
class TestPolicyDecideHandoff:
    ...
    def test_grave_objection_handoff(self):
    ...
    def test_high_objection_no_handoff(self):
...
class TestPolicyDecideConstraints:
    ...
    def test_grave_objection_constraints(self):
    ...
    def test_new_doctor_constraints(self):
    ...
    def test_cooling_off_constraints(self):
...
class TestPolicyDecideReasoning:
    ...
    def test_reasoning_includes_state(self):
    ...
    def test_reasoning_includes_objection(self):
...
class TestPolicyDecideAllowedActions:
    ...
    def test_initial_forbids_offer(self):
    ...
    def test_grave_objection_forbids_pressure(self):
    ...
    def test_hot_temperature_allows_offer(self):
