...
import { ChatSidebar, type ConversationItem } from '@/app/(dashboard)/conversas/components/chat-sidebar'
...
describe('ChatSidebar', () => {
  ...
  it('shows handoff indicator for human-controlled conversations', () => {
    ...
    const buttons = screen.getAllByRole('button')
    const humanControlledButton = buttons.find(btn => btn.textContent?.includes('Dra. Maria Santos'))
