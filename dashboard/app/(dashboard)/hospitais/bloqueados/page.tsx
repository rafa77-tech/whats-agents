    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-500">Julia nao oferece vagas de hospitais bloqueados</p>
        </div>
      ...
      <Tabs value={tab} onValueChange={(v) => setTab(v as typeof tab)}>
        <TabsList>
          <TabsTrigger value="ativos">Bloqueados Ativos ({bloqueados.length})</TabsTrigger>
                ...
                {loading ? (
                  ...
                  bloqueados.map((hospital) => (
                    <TableRow key={hospital.id}>
                      ...
                      <TableCell>
                        <Badge variant="outline">{hospital.vagas_movidas ?? 0} vagas</Badge>
                      </TableCell>
                      <TableCell>
                        <Button
                          variant="outline"
      ...
      <AlertDialog open={!!desbloquearDialog} onOpenChange={() => setDesbloquearDialog(null)}>
        <AlertDialogContent>
          <AlertDialogHeader>
              ...
              <div>
                {desbloquearDialog && (
                  <>
                    ...
                    <br />
                    <br />
                    Vagas futuras deste hospital serao restauradas e Julia voltara a ofertas
                    normalmente.
                  </>
                )}
              </div>
          ...
          <AlertDialogFooter>
            ...
            <AlertDialogAction
              ...
              disabled={updating}
            >
              {updating ? <Loader2 className="h-4 w-4 animate-spin" /> : 'Confirmar desbloqueio'}
            </AlertDialogAction>
          </AlertDialogFooter>
        </AlertDialogContent>
      </AlertDialog>
