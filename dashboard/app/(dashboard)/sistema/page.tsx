    ...
    <div className="space-y-6 p-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Controles operacionais da Julia</p>
        </div>
      </div>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        {/* Julia Toggle */}
        <JuliaToggle status={data.julia} onToggle={handleToggle} onPause={handlePause} />

        {/* Rate Limit */}
        <RateLimitCard status={data.rate_limit} onUpdate={handleUpdateRateLimit} />

        {/* Circuit Breakers */}
        <CircuitBreakerCard status={data.circuits} onReset={handleResetCircuit} />
