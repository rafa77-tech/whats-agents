/**
 * Alerts Tab Content - Sprint 45
 *
 * Conteudo da tab Alertas (sem header).
 * Refatorado de alerts-page-content.tsx para uso com tabs.
 */
...
const typeOptions: { value: ChipAlertType; label: string }[] = [
  ...
  { value: 'DESCONEXAO', label: 'Desconexao' },
  { value: 'LIMITE_PROXIMO', label: 'Limite Proximo' },
  { value: 'FASE_ESTAGNADA', label: 'Fase Estagnada' },
  { value: 'QUALIDADE_META', label: 'Qualidade Meta' },
  { value: 'COMPORTAMENTO_ANOMALO', label: 'Comportamento Anomalo' },
]
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        >
          ...
          <SelectContent>
            ...
            <SelectItem value="unresolved">Nao resolvidos</SelectItem>
          ...
          <CardContent className="p-8 text-center">
            ...
            <p className="text-muted-foreground">
              {filters.resolved === false
                ? 'Nao ha alertas pendentes. Otimo trabalho!'
